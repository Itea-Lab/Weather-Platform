  ...
  return (
    <div className="relative">
      <div className="relative">
        <button
          type="button"
          className="flex h-10 w-full min-w-[200px] items-center justify-between rounded-md border border-gray-300 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#a8cd89] focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
              ...
              {availableTopics.map((topic) => (
                ...
                >
                  ...
                  {selectedTopic === topic.value && (
                    <Check className="ml-2 h-4 w-4 text-[#a8cd89]" />
                  )}
                </button>
              ))}
            </div>
